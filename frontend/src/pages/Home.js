        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 dark:from-black dark:via-slate-900 dark:to-black">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    {/* Search and Filters */}
                    <div className={`bg-white/70 dark:bg-gray-900/80  dark:to-gray-900 backdrop-blur-xl rounded-3xl shadow-2xl p-6 mb-10 transition-all duration-700 ${isFirstLoad ? 'translate-y-12 opacity-0' : 'translate-y-0 opacity-100'} hover:shadow-3xl border border-white/30 dark:border-blue-800/30`}>
