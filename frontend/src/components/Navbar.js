  ...
  return (
    <nav className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-gray-900 dark:to-gray-800 text-white p-4 flex justify-between items-center shadow-md sticky top-0 z-50">
      ...
      >
        ...
        <span className="hidden sm:inline">Explore Sphere</span>
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          {menuOpen && (
            <div 
              className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 text-gray-800 dark:text-white rounded-lg shadow-xl z-50 overflow-hidden transition-all duration-200 transform origin-top-right"
            >
              {authenticated ? (
                <>
                  <Link
